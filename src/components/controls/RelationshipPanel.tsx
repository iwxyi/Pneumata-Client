...
function buildAxisLabels(entry: RelationshipLedgerEntry, mode: 'light' | 'dark') {
  ...
  return [
    { key: 'warmth' as const, label: '亲和', value: value('warmth'), color: relationshipAxisValueColor('warmth', (baseline.warmth || 0) + (adjustment.warmth || 0), mode), deltaColor: relationshipAxisDeltaColor('warmth', adjustment.warmth || 0, mode), x: 56, y: 10, anchor: 'middle' as const, labelDy: 0, valueDy: 12 },
    { key: 'competence' as const, label: '能力', value: value('competence'), color: relationshipAxisValueColor('competence', (baseline.competence || 0) + (adjustment.competence || 0), mode), deltaColor: relationshipAxisDeltaColor('competence', adjustment.competence || 0, mode), x: 99, y: 30, anchor: 'start' as const, labelDy: -4, valueDy: 9 },
    { key: 'trust' as const, label: '信任', value: value('trust'), color: relationshipAxisValueColor('trust', (baseline.trust || 0) + (adjustment.trust || 0), mode), deltaColor: relationshipAxisDeltaColor('trust', adjustment.trust || 0, mode), x: 99, y: 84, anchor: 'start' as const, labelDy: -4, valueDy: 9 },
    { key: 'threat' as const, label: '威胁', value: value('threat'), color: relationshipAxisValueColor('threat', (baseline.threat || 0) + (adjustment.threat || 0), mode), deltaColor: relationshipAxisDeltaColor('threat', adjustment.threat || 0, mode), x: 56, y: 112, anchor: 'middle' as const, labelDy: 0, valueDy: 12 },
    { key: 'attachment' as const, label: '在意', value: value('attachment'), color: relationshipAxisValueColor('attachment', (baseline.attachment || 0) + (adjustment.attachment || 0), mode), deltaColor: relationshipAxisDeltaColor('attachment', adjustment.attachment || 0, mode), x: 13, y: 84, anchor: 'end' as const, labelDy: -4, valueDy: 9 },
    { key: 'deference' as const, label: '让位', value: value('deference'), color: relationshipAxisValueColor('deference', (baseline.deference || 0) + (adjustment.deference || 0), mode), deltaColor: relationshipAxisDeltaColor('deference', adjustment.deference || 0, mode), x: 13, y: 30, anchor: 'end' as const, labelDy: -4, valueDy: 9 },
  ];
}
