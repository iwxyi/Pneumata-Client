...
export function buildInlineInteractionContract(params: {
  ...
  const intentionalRepeatRules = `\n\nRules for intentionalRepeat:\n1. Default intentionalRepeat=false.\n2. Set intentionalRepeat=true only when the visible message deliberately quotes, mimics, or throws back another member's wording as the social move.\n3. Do not use intentionalRepeat=true just because you copied the room's recent emoji, opener, catchphrase, or sentence cadence.`;
